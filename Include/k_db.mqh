...
bool MySQL_NoError(int dbConnectId) {
   ...
   if(errno == 2006 || errno == 2013){
      ...
      connect_db(g_db_connect_id, g_db_host_setting, g_db_user_setting, g_db_pass_setting, g_db_name_setting, g_db_port_setting, g_db_socket_setting, g_db_client_setting);
   }
   else if ( errno > 0 ) {
